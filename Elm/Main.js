...
var $author$project$Main$Model = function (commandes) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$placeholder('exemple : [Repeat 360 [ Right 1, Forward 1]]'),
						$elm$html$Html$Attributes$value(model.commandes)
					]),
				_List_Nil),
				A2(
